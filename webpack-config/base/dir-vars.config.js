...
moduleExports.templateDir = path.resolve(moduleExports.publicDir, './template'); // 存放UI布局，组织各个组件拼起来，因应需要可以有不同的布局套路
moduleExports.fontStaticPublic = "/fab/APP/build/";// 字体文件路径
